<x-app-layout>
    <section class="home-section">
        <div class="container-fluid">
            ...
            <a href="{{ route('fee_categories.create') }}" class="btn btn-success mb-3 mt-3">Add New Category
                +</a>
            @if (session('success'))
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <table id="fee-categories-table" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
    ...
    <script>
        $(document).ready(function() {
            $('#fee-categories-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('fee_categories.index') }}',
                lengthMenu: [
                    [10, 25, 50, 100],
                    [10, 25, 50, 100]
