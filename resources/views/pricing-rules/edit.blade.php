                    ...
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">تعديل قاعدة التسعير</h5>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('pricing-rules.update', $pricingRule) }}" method="POST"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select
                                                ...
                                                @foreach ($tariffCategories as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ old('tariff_category_id', $pricingRule->tariff_category_id) == $id ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                name="name" value="{{ old('name', $pricingRule->name) }}" required>
                                            @error('name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.01" min="0"
                                                    ...
                                                    id="rate" name="rate"
                                                    value="{{ old('rate', $pricingRule->rate) }}" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" step="1" min="0"
                                                ...
                                                value="{{ old('priority', $pricingRule->priority) }}" required>
                                            @error('priority')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('effective_from', $pricingRule->effective_from ? $pricingRule->effective_from->format('Y-m-d') : '') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('effective_to', $pricingRule->effective_to ? $pricingRule->effective_to->format('Y-m-d') : '') }}">
                                            @error('effective_to')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <input type="hidden" name="conditions" id="conditions-json"
                                        value="{{ old('conditions', json_encode($pricingRule->conditions)) }}">
                                    @error('conditions')
