<x-app-layout>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">إضافة نوع شرط جديد</h5>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('condition-types.store') }}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('operator_type') is-invalid @enderror"
                                                ...
                                                @foreach ($operatorTypes as $value => $label)
                                                    <option value="{{ $value }}"
                                                        {{ old('operator_type') == $value ? 'selected' : '' }}>
                                                        {{ $label }}</option>
                                                @endforeach
                                            </select>
                                            @error('operator_type')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // استرجاع العمليات المحددة سابقًا (إن وجدت)
            const oldOperators = @json(old('available_operators', []));
            ...
            function updateAvailableOperators() {
                ...
                operators.forEach(op => {
                    ...
                    const checked = oldOperators.includes(op) ? 'checked' : '';
            ...
            // تحديث العمليات المتاحة عند تحميل الصفحة إذا كان هناك نوع عمليات محدد مسبقًا
            if (operatorTypeSelect.value) {
                updateAvailableOperators();
            }
        });
    </script>
