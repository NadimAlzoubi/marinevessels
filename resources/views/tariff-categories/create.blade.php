                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">إضافة فئة تعريفة جديدة</h5>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('tariff-categories.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('service_id') is-invalid @enderror"
                                            ...
                                            @foreach ($services as $id => $name)
                                                <option value="{{ $id }}"
                                                    {{ old('service_id', $selectedServiceId) == $id ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>
                                        @error('service_id')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('unit_of_measurement') }}" required>
